...
import org.eclipse.xpanse.modules.plugin.credential.CreateCredential;
import org.eclipse.xpanse.modules.plugin.credential.CredentialVariable;
import org.eclipse.xpanse.modules.plugin.credential.CredentialVariables;
...
class CredentialManageApiTest {
    ...
    void testGetCredentialDefinitionsByCsp_CredentialCenterReturnsNoItems() {
        // Setup
        when(mockCredentialCenter.getCredentials(Csp.AWS, "userName", CredentialType.VARIABLES)).thenReturn(Collections.emptyList());
