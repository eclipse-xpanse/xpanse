...
class ServiceStateManageApiTest extends ApisTestCommon {
    ...
    void testServiceStateManageApisThrowExceptions(ServiceDeploymentEntity service)
        ...
        assertNotNull(response1.getHeader(HEADER_TRACKING_ID));
        OrderFailedErrorResponse orderFailedResponse =
                objectMapper.readValue(
                        response1.getContentAsString(), OrderFailedErrorResponse.class);
        assertEquals(ErrorType.SERVICE_DEPLOYMENT_NOT_FOUND, orderFailedResponse.getErrorType());
        assertEquals(orderFailedResponse.getDetails(), List.of(errorMsg1));
        ...
        assertNotNull(response2.getHeader(HEADER_TRACKING_ID));
        orderFailedResponse =
                objectMapper.readValue(
                        response2.getContentAsString(), OrderFailedErrorResponse.class);
        assertEquals(ErrorType.PLUGIN_NOT_FOUND, orderFailedResponse.getErrorType());
        assertEquals(orderFailedResponse.getDetails(), List.of(errorMsg2));
        assertEquals(orderFailedResponse.getServiceId(), serviceId.toString());
        ...
        assertNotNull(response3.getHeader(HEADER_TRACKING_ID));
        orderFailedResponse =
                objectMapper.readValue(
                        response3.getContentAsString(), OrderFailedErrorResponse.class);
        assertEquals(ErrorType.ACCESS_DENIED, orderFailedResponse.getErrorType());
        assertEquals(orderFailedResponse.getDetails(), List.of(errorMsg3));
        assertEquals(orderFailedResponse.getServiceId(), serviceId.toString());
        ...
        String errorMsg4 =
                String.format(
                        "Request with type %s to the service %s with the deployment state %s is"
                                + " not allowed.",
                        ServiceOrderType.SERVICE_START.toValue(),
                        serviceId,
                        service.getServiceDeploymentState().toValue());
        // run the test
        ...
        assertNotNull(response4.getHeader(HEADER_TRACKING_ID));
        orderFailedResponse =
                objectMapper.readValue(
                        response4.getContentAsString(), OrderFailedErrorResponse.class);
        assertEquals(
                ErrorType.SERVICE_DEPLOYMENT_STATE_INVALID, orderFailedResponse.getErrorType());
        assertEquals(orderFailedResponse.getDetails(), List.of(errorMsg4));
        assertEquals(orderFailedResponse.getServiceId(), serviceId.toString());
        ...
        // Verify the results
        assertEquals(HttpStatus.BAD_REQUEST.value(), response5.getStatus());
        assertNotNull(response5.getHeader(HEADER_TRACKING_ID));
        orderFailedResponse =
                objectMapper.readValue(
                        response5.getContentAsString(), OrderFailedErrorResponse.class);
        assertEquals(ErrorType.SERVICE_STATE_INVALID, orderFailedResponse.getErrorType());
        assertEquals(orderFailedResponse.getDetails(), List.of(errorMsg5));
        assertEquals(orderFailedResponse.getServiceId(), serviceId.toString());
        ...
        // Verify the results
        assertEquals(HttpStatus.BAD_REQUEST.value(), response6.getStatus());
        assertNotNull(response6.getHeader(HEADER_TRACKING_ID));
        orderFailedResponse =
                objectMapper.readValue(
                        response6.getContentAsString(), OrderFailedErrorResponse.class);
        assertEquals(ErrorType.SERVICE_STATE_INVALID, orderFailedResponse.getErrorType());
        assertEquals(orderFailedResponse.getDetails(), List.of(errorMsg6));
        assertEquals(orderFailedResponse.getServiceId(), serviceId.toString());
        ...
        // Verify the results
        assertEquals(HttpStatus.BAD_REQUEST.value(), response7.getStatus());
        assertNotNull(response7.getHeader(HEADER_TRACKING_ID));
        orderFailedResponse =
                objectMapper.readValue(
                        response7.getContentAsString(), OrderFailedErrorResponse.class);
        assertEquals(ErrorType.SERVICE_STATE_INVALID, orderFailedResponse.getErrorType());
        assertEquals(orderFailedResponse.getDetails(), List.of(errorMsg7));
        assertEquals(orderFailedResponse.getServiceId(), serviceId.toString());
        ...
        // Verify the results
        assertEquals(HttpStatus.BAD_REQUEST.value(), response8.getStatus());
        assertNotNull(response8.getHeader(HEADER_TRACKING_ID));
        orderFailedResponse =
                objectMapper.readValue(
                        response8.getContentAsString(), OrderFailedErrorResponse.class);
        assertEquals(ErrorType.SERVICE_STATE_INVALID, orderFailedResponse.getErrorType());
        assertEquals(orderFailedResponse.getDetails(), List.of(errorMsg8));
        assertEquals(orderFailedResponse.getServiceId(), serviceId.toString());
        ...
        // Verify the results
        assertEquals(HttpStatus.BAD_REQUEST.value(), response9.getStatus());
        assertNotNull(response9.getHeader(HEADER_TRACKING_ID));
        orderFailedResponse =
                objectMapper.readValue(
                        response9.getContentAsString(), OrderFailedErrorResponse.class);
        assertEquals(ErrorType.SERVICE_STATE_INVALID, orderFailedResponse.getErrorType());
        assertEquals(orderFailedResponse.getDetails(), List.of(errorMsg9));
        assertEquals(orderFailedResponse.getServiceId(), serviceId.toString());
        ...
        // Verify the results
        assertEquals(HttpStatus.BAD_REQUEST.value(), response10.getStatus());
        assertNotNull(response10.getHeader(HEADER_TRACKING_ID));
        orderFailedResponse =
                objectMapper.readValue(
                        response10.getContentAsString(), OrderFailedErrorResponse.class);
        assertEquals(ErrorType.SERVICE_LOCKED, orderFailedResponse.getErrorType());
        assertEquals(orderFailedResponse.getDetails(), List.of(errorMsg10));
        assertEquals(orderFailedResponse.getServiceId(), serviceId.toString());
        ...
        // Verify the results
        assertEquals(HttpStatus.BAD_REQUEST.value(), response11.getStatus());
        assertNotNull(response11.getHeader(HEADER_TRACKING_ID));
        orderFailedResponse =
                objectMapper.readValue(
                        response11.getContentAsString(), OrderFailedErrorResponse.class);
        assertEquals(ErrorType.SERVICE_LOCKED, orderFailedResponse.getErrorType());
        assertEquals(orderFailedResponse.getDetails(), List.of(errorMsg11));
        assertEquals(orderFailedResponse.getServiceId(), serviceId.toString());
    }
