...
public class PoliciesValidateApi {
    ...
    /**
     * Validate the policies Validate the policies
     *
     * <p><b>200</b> - OK
     *
     ...
     */
    public ValidateResponse validatePoliciesPost(ValidatePolicyList policyList)
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<ValidateResponse> validatePoliciesPostWithHttpInfo(
            ValidatePolicyList policyList) throws RestClientException {
        ...
        if (policyList == null) {
            throw new HttpClientErrorException(
                    ...
                    "Missing the required parameter 'policyList' when calling"
                            + " validatePoliciesPost");
        }
        ...
        ParameterizedTypeReference<ValidateResponse> localReturnType =
                new ParameterizedTypeReference<ValidateResponse>() {};
