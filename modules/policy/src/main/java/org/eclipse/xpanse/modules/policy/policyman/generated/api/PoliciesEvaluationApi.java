...
public class PoliciesEvaluationApi {
    ...
    /**
     * Evaluate the input by policies Evaluate whether the input meets all the policies
     *
     * <p><b>200</b> - OK
     *
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<EvalResult> evaluatePoliciesPostWithHttpInfo(EvalCmdList cmdList)
        ...
        if (cmdList == null) {
            throw new HttpClientErrorException(
                    ...
                    "Missing the required parameter 'cmdList' when calling evaluatePoliciesPost");
        }
        ...
        ParameterizedTypeReference<EvalResult> localReturnType =
                new ParameterizedTypeReference<EvalResult>() {};
    ...
    /**
     * Evaluate the input by policies Evaluate the input by all the policies and get raw result
     *
     * <p><b>200</b> - OK
     *
     * <p><b>400</b> - Bad Request
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<RegoResult> evaluatePoliciesRawPost(EvalCmdList cmdList)
            throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<RegoResult>> evaluatePoliciesRawPostWithHttpInfo(EvalCmdList cmdList)
            throws RestClientException {
        Object localVarPostBody = cmdList;
        ...
        if (cmdList == null) {
            throw new HttpClientErrorException(
                    HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'cmdList' when calling"
                            + " evaluatePoliciesRawPost");
        }
        ...
        ParameterizedTypeReference<List<RegoResult>> localReturnType =
                new ParameterizedTypeReference<List<RegoResult>>() {};
        return apiClient.invokeAPI(
    ...
    /**
     * Evaluate the input by policies Evaluate whether the input meets the policy
     *
     * <p><b>200</b> - OK
     *
     * <p><b>400</b> - Bad Request
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<EvalResult> evaluatePolicyPostWithHttpInfo(EvalCmd cmd)
            throws RestClientException {
        ...
        if (cmd == null) {
            throw new HttpClientErrorException(
                    HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'cmd' when calling evaluatePolicyPost");
        }
    ...
    /**
     * Evaluate the input by policies Evaluate the input by the policy and get raw result
     *
     * <p><b>200</b> - OK
     *
     * <p><b>400</b> - Bad Request
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<RegoResult>> evaluatePolicyRawPostWithHttpInfo(EvalCmd cmd)
            throws RestClientException {
        Object localVarPostBody = cmd;
        ...
        if (cmd == null) {
            throw new HttpClientErrorException(
                    HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'cmd' when calling evaluatePolicyRawPost");
        }
