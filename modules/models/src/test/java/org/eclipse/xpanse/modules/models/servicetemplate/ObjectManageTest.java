...
public class ObjectManageTest {
    ...
    private final String objectHandler = "primary-server";
    ...
    @Mock private ObjectHandlerScript objectHandlerScript;
    ...
    void setUp() {
        ...
        objectManage.setObjectHandler(objectHandler);
    ...
    void testGetters() {
        ...
        assertEquals(objectHandler, objectManage.getObjectHandler());
