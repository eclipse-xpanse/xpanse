...
class ErrorTypeTest {
    ...
    void testToValue() {
        ...
        assertEquals("Service Template Already Registered",
                ErrorType.SERVICE_TEMPLATE_ALREADY_REGISTERED.toValue());
    ...
    void testGetResultTypeByValue() {
        ...
        assertEquals(ErrorType.SERVICE_TEMPLATE_ALREADY_REGISTERED,
                ErrorType.getResultTypeByValue("Service Template Already Registered"));
