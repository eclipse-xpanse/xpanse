...
class ErrorTypeTest {
    ...
    void testToValue() {
        ...
        assertEquals("Terraform Script Invalid", ErrorType.TERRAFORM_SCRIPT_INVALID.toValue());
        assertEquals("Unprocessable Entity", ErrorType.UNPROCESSABLE_ENTITY.toValue());
        assertEquals("Response Not Valid", ErrorType.INVALID_RESPONSE.toValue());
        assertEquals("Failure while connecting to backend", ErrorType.BACKEND_FAILURE.toValue());
        assertEquals(
                "Credential Capability Not Found",
                ErrorType.CREDENTIAL_CAPABILITY_NOT_FOUND.toValue());
        assertEquals("Credentials Not Found", ErrorType.CREDENTIALS_NOT_FOUND.toValue());
        assertEquals(
        ...
        assertEquals("Terraform Execution Failed", ErrorType.TERRAFORM_EXECUTION_FAILED.toValue());
        ...
        assertEquals("Icon Processing Failed", ErrorType.ICON_PROCESSING_FAILED.toValue());
        assertEquals(
                "Service Template Not Registered",
                ErrorType.SERVICE_TEMPLATE_NOT_REGISTERED.toValue());
        assertEquals(
                "Service Deployment Not Found", ErrorType.SERVICE_DEPLOYMENT_NOT_FOUND.toValue());
        assertEquals("Resource Not Found", ErrorType.RESOURCE_NOT_FOUND.toValue());
    }

    @Test
    void testGetResultTypeByValue() {
        assertEquals(ErrorType.RUNTIME_ERROR, ErrorType.getResultTypeByValue("Runtime Error"));
        assertEquals(
                ErrorType.BAD_PARAMETERS, ErrorType.getResultTypeByValue("Parameters Invalid"));
        assertEquals(
                ErrorType.TERRAFORM_SCRIPT_INVALID,
        ...
        assertEquals(
                ErrorType.INVALID_RESPONSE, ErrorType.getResultTypeByValue("Response Not Valid"));
        assertEquals(
        ...
        assertEquals(ErrorType.FLAVOR_NOT_FOUND, ErrorType.getResultTypeByValue("Flavor Invalid"));
        assertEquals(
                ErrorType.TERRAFORM_EXECUTION_FAILED,
                ErrorType.getResultTypeByValue("Terraform Execution Failed"));
        assertEquals(
                ErrorType.PLUGIN_NOT_FOUND, ErrorType.getResultTypeByValue("Plugin Not Found"));
        assertEquals(
                ErrorType.DEPLOYER_NOT_FOUND, ErrorType.getResultTypeByValue("Deployer Not Found"));
        assertEquals(
        ...
        assertEquals(
                ErrorType.ICON_PROCESSING_FAILED,
        ...
        assertEquals(
                ErrorType.RESOURCE_NOT_FOUND, ErrorType.getResultTypeByValue("Resource Not Found"));
    ...
    void testGetTypeByValue() {
        ...
        assertEquals(ErrorType.RUNTIME_ERROR, test.getByValue("Runtime Error"));
        assertEquals(ErrorType.BAD_PARAMETERS, test.getByValue("Parameters Invalid"));
        assertEquals(
                ErrorType.TERRAFORM_SCRIPT_INVALID, test.getByValue("Terraform Script Invalid"));
        assertEquals(ErrorType.UNPROCESSABLE_ENTITY, test.getByValue("Unprocessable Entity"));
        assertEquals(ErrorType.INVALID_RESPONSE, test.getByValue("Response Not Valid"));
        assertEquals(
                ErrorType.BACKEND_FAILURE, test.getByValue("Failure while connecting to backend"));
        assertEquals(
                ErrorType.CREDENTIAL_CAPABILITY_NOT_FOUND,
                test.getByValue("Credential Capability Not Found"));
        assertEquals(ErrorType.CREDENTIALS_NOT_FOUND, test.getByValue("Credentials Not Found"));
        assertEquals(
                ErrorType.CREDENTIALS_VARIABLES_NOT_COMPLETE,
                test.getByValue("Credential Variables Not Complete"));
        assertEquals(ErrorType.FLAVOR_NOT_FOUND, test.getByValue("Flavor Invalid"));
        assertEquals(
                ErrorType.TERRAFORM_EXECUTION_FAILED,
                test.getByValue("Terraform Execution Failed"));
        assertEquals(ErrorType.PLUGIN_NOT_FOUND, test.getByValue("Plugin Not Found"));
        assertEquals(ErrorType.DEPLOYER_NOT_FOUND, test.getByValue("Deployer Not Found"));
        assertEquals(
                ErrorType.CREDENTIAL_DEFINITIONS_NOT_AVAILABLE,
                test.getByValue("No Credential Definition Available"));
        assertEquals(ErrorType.SERVICE_STATE_INVALID, test.getByValue("Invalid Service State"));
        assertEquals(
                ErrorType.RESOURCE_TYPE_INVALID_FOR_MONITORING,
                test.getByValue("Resource Invalid For Monitoring"));
        assertEquals(ErrorType.UNHANDLED_EXCEPTION, test.getByValue("Unhandled Exception"));
        assertEquals(
                ErrorType.SERVICE_TEMPLATE_REQUEST_NOT_ALLOWED,
                test.getByValue("Service Template Request Not Allowed"));
        assertEquals(ErrorType.ICON_PROCESSING_FAILED, test.getByValue("Icon Processing Failed"));
        assertEquals(
                ErrorType.SERVICE_TEMPLATE_NOT_REGISTERED,
        ...
        assertEquals(ErrorType.RESOURCE_NOT_FOUND, test.getByValue("Resource Not Found"));
