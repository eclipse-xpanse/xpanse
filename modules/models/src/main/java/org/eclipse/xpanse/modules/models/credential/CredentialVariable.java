...
public class CredentialVariable implements Cloneable {
    ...
    @Schema(
            description =
                    "If the variable is mandatory. If is optional then the credential completeness"
                        + " check will ignore this variable. It is upto the plugin to decide what"
    ...
    @Schema(
            description =
                    "Defines if the particular variable contains sensitive data. For example the"
                            + " value is false for username and true for password variables"
                            + " respectively.")
     ...
     */
    public CredentialVariable(
            String name, String description, Boolean isMandatory, Boolean isSensitive) {
        this.name = name;
        this.description = description;
