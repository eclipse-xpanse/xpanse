...
public class BillingCommonUtils {
     ...
     */
    public static Price getSpecificPriceByRegionAndSite(
            List<PriceWithRegion> prices, String region, String site) {
        ...
        Optional<PriceWithRegion> specificPrice =
                prices.stream()
                        .filter(
                                price ->
        ...
        Optional<PriceWithRegion> anyPrice =
                prices.stream()
                        .filter(
                                price ->
                                        StringUtils.equalsIgnoreCase(
