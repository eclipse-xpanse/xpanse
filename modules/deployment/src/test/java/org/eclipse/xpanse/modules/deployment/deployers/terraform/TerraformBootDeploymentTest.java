...
class TerraformBootDeploymentTest {
    ...
    void testDeploy() {
        ...
        final CreateRequest createRequest1 = new CreateRequest();
        createRequest1.setRegion("region");
        createRequest1.setCsp(Csp.HUAWEI);
        task.setCreateRequest(createRequest1);
        ...
        final CreateRequest createRequest2 = new CreateRequest();
        createRequest2.setRegion("region");
        createRequest2.setCsp(Csp.HUAWEI);
        task1.setCreateRequest(createRequest2);
        ...
        final CreateRequest createRequest3 = new CreateRequest();
        createRequest3.setRegion("region");
        createRequest3.setCsp(Csp.HUAWEI);
        task2.setCreateRequest(createRequest3);
        ...
        final CreateRequest createRequest4 = new CreateRequest();
        createRequest4.setRegion("region");
        createRequest4.setCsp(Csp.HUAWEI);
        task3.setCreateRequest(createRequest4);
        ...
        final CreateRequest createRequest5 = new CreateRequest();
        createRequest5.setRegion("region");
        createRequest5.setCsp(Csp.HUAWEI);
        task4.setCreateRequest(createRequest5);
    ...
    void testDestroy() {
        ...
        createRequest1.setRegion("region");
        createRequest1.setCsp(Csp.HUAWEI);
        task1.setCreateRequest(createRequest1);
        final Ocl ocl1 = new Ocl();
        final CloudServiceProvider cloudServiceProvider1 = new CloudServiceProvider();
        cloudServiceProvider1.setName(Csp.HUAWEI);
        final Region region1 = new Region();
        ...
        createRequest2.setRegion("region");
        createRequest2.setCsp(Csp.HUAWEI);
        task2.setCreateRequest(createRequest2);
        final Ocl ocl2 = new Ocl();
        final CloudServiceProvider cloudServiceProvider2 = new CloudServiceProvider();
        cloudServiceProvider2.setName(Csp.HUAWEI);
        final Region region2 = new Region();
        ...
        createRequest3.setRegion("region");
        createRequest3.setCsp(Csp.HUAWEI);
        task3.setCreateRequest(createRequest3);
        final Ocl ocl3 = new Ocl();
        final CloudServiceProvider cloudServiceProvider3 = new CloudServiceProvider();
        cloudServiceProvider3.setName(Csp.HUAWEI);
        final Region region3 = new Region();
        ...
        createRequest4.setRegion("region");
        createRequest4.setCsp(Csp.HUAWEI);
        task4.setCreateRequest(createRequest4);
        final Ocl ocl4 = new Ocl();
        final CloudServiceProvider cloudServiceProvider4 = new CloudServiceProvider();
        cloudServiceProvider4.setName(Csp.HUAWEI);
        final Region region4 = new Region();
        ...
        createRequest5.setRegion("region");
        createRequest5.setCsp(Csp.HUAWEI);
        task5.setCreateRequest(createRequest5);
        final Ocl ocl5 = new Ocl();
        final CloudServiceProvider cloudServiceProvider5 = new CloudServiceProvider();
        cloudServiceProvider5.setName(Csp.HUAWEI);
        final Region region5 = new Region();
