...
@ContextConfiguration(classes = {OpenTofuMakerServiceDeployer.class, DeployEnvironments.class, PluginManager.class,
OpenTofuFromScriptsApi.class, OpenTofuMakerConfig.class, DeployServiceEntityHandler.class, OpenTofuMakerScriptValidator.class,
        OpenTofuMakerServiceDeployer.class, OpenTofuMakerDeployment.class,
        OpenTofuMakerHelper.class, AdminApi.class, OpenTofuMakerDeploymentPlanManage.class,
OpenTofuMakerServiceDestroyer.class, OpenTofuProviderHelper.class})
@ExtendWith(SpringExtension.class)
@ActiveProfiles("tofu-maker")
class OpenTofuMakerDeploymentTest {
    ...
    @MockBean
    OpenTofuMakerConfig openTofuMakerConfig;
    @MockBean
    ...
    @Autowired
    private OpenTofuMakerDeployment openTofuMakerDeployment;
    ...
    void testValidate() {
        ...
        when(openTofuMakerScriptValidator.validateOpenTofuScripts(any())).thenReturn(expectedResult);
    ...
    void testValidate_ThrowsOpenTofuExecutorException() {
        ocl.getDeployment().setDeployer(errorDeployer);
        when(openTofuMakerScriptValidator.validateOpenTofuScripts(any())).thenThrow(
                new OpenTofuMakerRequestFailedException("IO error"));
        mockGetProvider();
        Assertions.assertThrows(OpenTofuMakerRequestFailedException.class,
