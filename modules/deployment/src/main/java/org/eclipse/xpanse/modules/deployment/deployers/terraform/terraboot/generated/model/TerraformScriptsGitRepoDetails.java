...
@JsonPropertyOrder({
    TerraformScriptsGitRepoDetails.JSON_PROPERTY_REPO_URL,
    TerraformScriptsGitRepoDetails.JSON_PROPERTY_BRANCH,
    TerraformScriptsGitRepoDetails.JSON_PROPERTY_SCRIPT_PATH
})
...
public class TerraformScriptsGitRepoDetails {
    ...
    public TerraformScriptsGitRepoDetails repoUrl(@jakarta.annotation.Nonnull String repoUrl) {
    ...
    public TerraformScriptsGitRepoDetails branch(@jakarta.annotation.Nonnull String branch) {
    ...
    public TerraformScriptsGitRepoDetails scriptPath(
    ...
    public boolean equals(Object o) {
        ...
        TerraformScriptsGitRepoDetails terraformScriptsGitRepoDetails =
                (TerraformScriptsGitRepoDetails) o;
        return Objects.equals(this.repoUrl, terraformScriptsGitRepoDetails.repoUrl)
                && Objects.equals(this.branch, terraformScriptsGitRepoDetails.branch)
                && Objects.equals(this.scriptPath, terraformScriptsGitRepoDetails.scriptPath);
    }
    ...
    public String toString() {
        ...
        sb.append("class TerraformScriptsGitRepoDetails {\n");
