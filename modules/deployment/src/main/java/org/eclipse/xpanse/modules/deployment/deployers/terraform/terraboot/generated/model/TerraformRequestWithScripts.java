...
/** Terraform request with scripts files */
@JsonPropertyOrder({
    TerraformRequestWithScripts.JSON_PROPERTY_REQUEST_ID,
    TerraformRequestWithScripts.JSON_PROPERTY_REQUEST_TYPE,
    TerraformRequestWithScripts.JSON_PROPERTY_TERRAFORM_VERSION,
    TerraformRequestWithScripts.JSON_PROPERTY_IS_PLAN_ONLY,
    TerraformRequestWithScripts.JSON_PROPERTY_VARIABLES,
    TerraformRequestWithScripts.JSON_PROPERTY_ENV_VARIABLES,
    TerraformRequestWithScripts.JSON_PROPERTY_TF_STATE,
    TerraformRequestWithScripts.JSON_PROPERTY_SCRIPT_FILES
})
@jakarta.annotation.Generated(
        value = "org.openapitools.codegen.languages.JavaClientCodegen",
        comments = "Generator version: 7.11.0")
public class TerraformRequestWithScripts {
    ...
    public TerraformRequestWithScripts() {}

    public TerraformRequestWithScripts requestId(@jakarta.annotation.Nonnull UUID requestId) {
    ...
    public TerraformRequestWithScripts requestType(
    ...
    public TerraformRequestWithScripts terraformVersion(
    ...
    public TerraformRequestWithScripts isPlanOnly(@jakarta.annotation.Nonnull Boolean isPlanOnly) {
    ...
    public TerraformRequestWithScripts variables(
    ...
    public TerraformRequestWithScripts putVariablesItem(String key, Object variablesItem) {
    ...
    public TerraformRequestWithScripts envVariables(
    ...
    public TerraformRequestWithScripts putEnvVariablesItem(String key, String envVariablesItem) {
    ...
    public TerraformRequestWithScripts tfState(@jakarta.annotation.Nullable String tfState) {
    ...
    public TerraformRequestWithScripts scriptFiles(
    ...
    public TerraformRequestWithScripts putScriptFilesItem(String key, String scriptFilesItem) {
    ...
    public boolean equals(Object o) {
        ...
        TerraformRequestWithScripts terraformRequestWithScripts = (TerraformRequestWithScripts) o;
        return Objects.equals(this.requestId, terraformRequestWithScripts.requestId)
                && Objects.equals(this.requestType, terraformRequestWithScripts.requestType)
                && Objects.equals(
                        this.terraformVersion, terraformRequestWithScripts.terraformVersion)
                && Objects.equals(this.isPlanOnly, terraformRequestWithScripts.isPlanOnly)
                && Objects.equals(this.variables, terraformRequestWithScripts.variables)
                && Objects.equals(this.envVariables, terraformRequestWithScripts.envVariables)
                && Objects.equals(this.tfState, terraformRequestWithScripts.tfState)
                && Objects.equals(this.scriptFiles, terraformRequestWithScripts.scriptFiles);
    }
    ...
    public String toString() {
        ...
        sb.append("class TerraformRequestWithScripts {\n");
