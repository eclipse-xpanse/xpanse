...
@Component("org.eclipse.xpanse.modules.deployment.deployers.terraform.terraformboot.generated.api.RetrieveTerraformResultApi")
public class RetrieveTerraformResultApi extends BaseApi {
    ...
    /**
     * 
     * Method to retrieve stored terraform result in case terraform-boot receives a failure while sending the terraform result via callback.
     ...
     */
    public TerraformResult getStoredTaskResultByRequestId(String requestId) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<TerraformResult> getStoredTaskResultByRequestIdWithHttpInfo(String requestId) throws RestClientException {
        ...
        return apiClient.invokeAPI("/terraform-boot/task/result/{requestId}", HttpMethod.GET, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
