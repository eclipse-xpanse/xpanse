...
public class TerraformResult {
  ...
  public TerraformResult destroyScenario(String destroyScenario) {
   ...
   /**
   * Value of destroy scenario filled into the result of destroy request. Valid values: destroy,rollback,purge.
  ...
  **/
  ...
  public String getDestroyScenario() {
    return destroyScenario;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DESTROY_SCENARIO)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDestroyScenario(String destroyScenario) {
    this.destroyScenario = destroyScenario;
  }
