 ...
 * TerraformResult
 */
@JsonPropertyOrder({TerraformResult.JSON_PROPERTY_REQUEST_ID, TerraformResult.JSON_PROPERTY_COMMAND_STD_OUTPUT,
        TerraformResult.JSON_PROPERTY_COMMAND_STD_ERROR, TerraformResult.JSON_PROPERTY_TERRAFORM_STATE,
        TerraformResult.JSON_PROPERTY_GENERATED_FILE_CONTENT_MAP, TerraformResult.JSON_PROPERTY_TERRAFORM_VERSION_USED,
...
public class TerraformResult {
    ...
    public TerraformResult putGeneratedFileContentMapItem(String key, String generatedFileContentMapItem) {
    ...
    /**
     * Data of all other files generated by the terraform execution.The map key contains the file name and value is
    ...
    public TerraformResult terraformVersionUsed(@jakarta.annotation.Nullable String terraformVersionUsed) {
    ...
    public TerraformResult commandSuccessful(@jakarta.annotation.Nullable Boolean commandSuccessful) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.requestId, terraformResult.requestId) &&
                ...
                Objects.equals(this.generatedFileContentMap, terraformResult.generatedFileContentMap) &&
