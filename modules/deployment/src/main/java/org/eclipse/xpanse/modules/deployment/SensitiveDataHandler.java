    ...
    public void handleSensitiveDataInOutputVariables(
        ...
        outputVariables.stream()
                ...
                .forEach(
                        variable -> {
                            if (outputProperties.containsKey(variable.getName())) {
                                if (SensitiveScope.ONCE.equals(variable.getSensitiveScope())) {
                                    outputProperties.put(variable.getName(), SENSITIVE_VALUE);
                                } else if (SensitiveScope.ALWAYS.equals(
                                        variable.getSensitiveScope())) {
                                    String decodedValue =
                                            String.valueOf(
