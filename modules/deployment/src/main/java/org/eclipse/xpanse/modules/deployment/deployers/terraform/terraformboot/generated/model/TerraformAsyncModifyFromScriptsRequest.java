...
public class TerraformAsyncModifyFromScriptsRequest {
    ...
    public TerraformAsyncModifyFromScriptsRequest terraformVersion(
    ...
    public TerraformAsyncModifyFromScriptsRequest envVariables(
    ...
    public TerraformAsyncModifyFromScriptsRequest taskId(@jakarta.annotation.Nullable UUID taskId) {
    ...
    public TerraformAsyncModifyFromScriptsRequest webhookConfig(
