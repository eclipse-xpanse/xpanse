...
/** Terraform async request with scripts files */
@JsonPropertyOrder({
    TerraformAsyncRequestWithScripts.JSON_PROPERTY_REQUEST_ID,
    TerraformAsyncRequestWithScripts.JSON_PROPERTY_REQUEST_TYPE,
    TerraformAsyncRequestWithScripts.JSON_PROPERTY_TERRAFORM_VERSION,
    TerraformAsyncRequestWithScripts.JSON_PROPERTY_IS_PLAN_ONLY,
    TerraformAsyncRequestWithScripts.JSON_PROPERTY_VARIABLES,
    TerraformAsyncRequestWithScripts.JSON_PROPERTY_ENV_VARIABLES,
    TerraformAsyncRequestWithScripts.JSON_PROPERTY_TF_STATE,
    TerraformAsyncRequestWithScripts.JSON_PROPERTY_SCRIPT_FILES,
    TerraformAsyncRequestWithScripts.JSON_PROPERTY_WEBHOOK_CONFIG
})
@jakarta.annotation.Generated(
        value = "org.openapitools.codegen.languages.JavaClientCodegen",
        comments = "Generator version: 7.11.0")
public class TerraformAsyncRequestWithScripts {
    ...
    public TerraformAsyncRequestWithScripts() {}

    public TerraformAsyncRequestWithScripts requestId(@jakarta.annotation.Nonnull UUID requestId) {
    ...
    public TerraformAsyncRequestWithScripts requestType(
    ...
    public TerraformAsyncRequestWithScripts terraformVersion(
    ...
    public TerraformAsyncRequestWithScripts isPlanOnly(
    ...
    public TerraformAsyncRequestWithScripts variables(
    ...
    public TerraformAsyncRequestWithScripts putVariablesItem(String key, Object variablesItem) {
    ...
    public TerraformAsyncRequestWithScripts envVariables(
    ...
    public TerraformAsyncRequestWithScripts putEnvVariablesItem(
    ...
    public TerraformAsyncRequestWithScripts tfState(@jakarta.annotation.Nullable String tfState) {
    ...
    public TerraformAsyncRequestWithScripts scriptFiles(
    ...
    public TerraformAsyncRequestWithScripts putScriptFilesItem(String key, String scriptFilesItem) {
    ...
    public TerraformAsyncRequestWithScripts webhookConfig(
    ...
    public boolean equals(Object o) {
        ...
        TerraformAsyncRequestWithScripts terraformAsyncRequestWithScripts =
                (TerraformAsyncRequestWithScripts) o;
        return Objects.equals(this.requestId, terraformAsyncRequestWithScripts.requestId)
                && Objects.equals(this.requestType, terraformAsyncRequestWithScripts.requestType)
                && Objects.equals(
                        this.terraformVersion, terraformAsyncRequestWithScripts.terraformVersion)
                && Objects.equals(this.isPlanOnly, terraformAsyncRequestWithScripts.isPlanOnly)
                && Objects.equals(this.variables, terraformAsyncRequestWithScripts.variables)
                && Objects.equals(this.envVariables, terraformAsyncRequestWithScripts.envVariables)
                && Objects.equals(this.tfState, terraformAsyncRequestWithScripts.tfState)
                && Objects.equals(this.scriptFiles, terraformAsyncRequestWithScripts.scriptFiles)
                && Objects.equals(
                        this.webhookConfig, terraformAsyncRequestWithScripts.webhookConfig);
    }
    ...
    public String toString() {
        ...
        sb.append("class TerraformAsyncRequestWithScripts {\n");
