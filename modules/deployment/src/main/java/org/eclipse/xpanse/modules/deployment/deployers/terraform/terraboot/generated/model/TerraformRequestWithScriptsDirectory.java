...
/** Terraform request with directory where scripts files exist */
@JsonPropertyOrder({
    TerraformRequestWithScriptsDirectory.JSON_PROPERTY_REQUEST_ID,
    TerraformRequestWithScriptsDirectory.JSON_PROPERTY_REQUEST_TYPE,
    TerraformRequestWithScriptsDirectory.JSON_PROPERTY_TERRAFORM_VERSION,
    TerraformRequestWithScriptsDirectory.JSON_PROPERTY_IS_PLAN_ONLY,
    TerraformRequestWithScriptsDirectory.JSON_PROPERTY_VARIABLES,
    TerraformRequestWithScriptsDirectory.JSON_PROPERTY_ENV_VARIABLES,
    TerraformRequestWithScriptsDirectory.JSON_PROPERTY_TF_STATE,
    TerraformRequestWithScriptsDirectory.JSON_PROPERTY_SCRIPTS_DIRECTORY
})
@jakarta.annotation.Generated(
        value = "org.openapitools.codegen.languages.JavaClientCodegen",
        comments = "Generator version: 7.11.0")
public class TerraformRequestWithScriptsDirectory {
    ...
    public TerraformRequestWithScriptsDirectory() {}

    public TerraformRequestWithScriptsDirectory requestId(
    ...
    public TerraformRequestWithScriptsDirectory requestType(
    ...
    public TerraformRequestWithScriptsDirectory terraformVersion(
    ...
    public TerraformRequestWithScriptsDirectory isPlanOnly(
    ...
    public TerraformRequestWithScriptsDirectory variables(
    ...
    public TerraformRequestWithScriptsDirectory putVariablesItem(String key, Object variablesItem) {
    ...
    public TerraformRequestWithScriptsDirectory envVariables(
    ...
    public TerraformRequestWithScriptsDirectory putEnvVariablesItem(
    ...
    public TerraformRequestWithScriptsDirectory tfState(
    ...
    public TerraformRequestWithScriptsDirectory scriptsDirectory(
    ...
    public boolean equals(Object o) {
        ...
        TerraformRequestWithScriptsDirectory terraformRequestWithScriptsDirectory =
                (TerraformRequestWithScriptsDirectory) o;
        return Objects.equals(this.requestId, terraformRequestWithScriptsDirectory.requestId)
                && Objects.equals(
                        this.requestType, terraformRequestWithScriptsDirectory.requestType)
                && Objects.equals(
                        this.terraformVersion,
                        terraformRequestWithScriptsDirectory.terraformVersion)
                && Objects.equals(this.isPlanOnly, terraformRequestWithScriptsDirectory.isPlanOnly)
                && Objects.equals(this.variables, terraformRequestWithScriptsDirectory.variables)
                && Objects.equals(
                        this.envVariables, terraformRequestWithScriptsDirectory.envVariables)
                && Objects.equals(this.tfState, terraformRequestWithScriptsDirectory.tfState)
                && Objects.equals(
                        this.scriptsDirectory,
                        terraformRequestWithScriptsDirectory.scriptsDirectory);
    }
    ...
    public String toString() {
        ...
        sb.append("class TerraformRequestWithScriptsDirectory {\n");
