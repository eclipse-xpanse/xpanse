...
/** OpenTofu async request with scripts files */
@JsonPropertyOrder({
    OpenTofuAsyncRequestWithScripts.JSON_PROPERTY_REQUEST_ID,
    OpenTofuAsyncRequestWithScripts.JSON_PROPERTY_REQUEST_TYPE,
    OpenTofuAsyncRequestWithScripts.JSON_PROPERTY_OPEN_TOFU_VERSION,
    OpenTofuAsyncRequestWithScripts.JSON_PROPERTY_IS_PLAN_ONLY,
    OpenTofuAsyncRequestWithScripts.JSON_PROPERTY_VARIABLES,
    OpenTofuAsyncRequestWithScripts.JSON_PROPERTY_ENV_VARIABLES,
    OpenTofuAsyncRequestWithScripts.JSON_PROPERTY_TF_STATE,
    OpenTofuAsyncRequestWithScripts.JSON_PROPERTY_SCRIPT_FILES,
    OpenTofuAsyncRequestWithScripts.JSON_PROPERTY_WEBHOOK_CONFIG
})
...
public class OpenTofuAsyncRequestWithScripts {
    ...
    public OpenTofuAsyncRequestWithScripts() {}

    public OpenTofuAsyncRequestWithScripts requestId(@jakarta.annotation.Nonnull UUID requestId) {
    ...
    public OpenTofuAsyncRequestWithScripts requestType(
    ...
    public OpenTofuAsyncRequestWithScripts openTofuVersion(
    ...
    public OpenTofuAsyncRequestWithScripts isPlanOnly(
    ...
    public OpenTofuAsyncRequestWithScripts variables(
    ...
    public OpenTofuAsyncRequestWithScripts putVariablesItem(String key, Object variablesItem) {
    ...
    public OpenTofuAsyncRequestWithScripts envVariables(
    ...
    public OpenTofuAsyncRequestWithScripts putEnvVariablesItem(
    ...
    public OpenTofuAsyncRequestWithScripts tfState(@jakarta.annotation.Nullable String tfState) {
    ...
    public OpenTofuAsyncRequestWithScripts scriptFiles(
    ...
    public OpenTofuAsyncRequestWithScripts putScriptFilesItem(String key, String scriptFilesItem) {
    ...
    public OpenTofuAsyncRequestWithScripts webhookConfig(
    ...
    public boolean equals(Object o) {
        ...
        OpenTofuAsyncRequestWithScripts openTofuAsyncRequestWithScripts =
                (OpenTofuAsyncRequestWithScripts) o;
        return Objects.equals(this.requestId, openTofuAsyncRequestWithScripts.requestId)
                && Objects.equals(this.requestType, openTofuAsyncRequestWithScripts.requestType)
                && Objects.equals(
                        this.openTofuVersion, openTofuAsyncRequestWithScripts.openTofuVersion)
                && Objects.equals(this.isPlanOnly, openTofuAsyncRequestWithScripts.isPlanOnly)
                && Objects.equals(this.variables, openTofuAsyncRequestWithScripts.variables)
                && Objects.equals(this.envVariables, openTofuAsyncRequestWithScripts.envVariables)
                && Objects.equals(this.tfState, openTofuAsyncRequestWithScripts.tfState)
                && Objects.equals(this.scriptFiles, openTofuAsyncRequestWithScripts.scriptFiles)
                && Objects.equals(
                        this.webhookConfig, openTofuAsyncRequestWithScripts.webhookConfig);
    }
    ...
    public String toString() {
        ...
        sb.append("class OpenTofuAsyncRequestWithScripts {\n");
