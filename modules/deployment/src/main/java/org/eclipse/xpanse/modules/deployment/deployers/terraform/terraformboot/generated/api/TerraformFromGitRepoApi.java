...
public class TerraformFromGitRepoApi extends BaseApi {
     ...
     */
    public void asyncDeployFromGitRepo(TerraformAsyncDeployFromGitRepoRequest terraformAsyncDeployFromGitRepoRequest)
    ...
    public ResponseEntity<Void> asyncDeployFromGitRepoWithHttpInfo(
            TerraformAsyncDeployFromGitRepoRequest terraformAsyncDeployFromGitRepoRequest) throws RestClientException {
        ...
        if (terraformAsyncDeployFromGitRepoRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformAsyncDeployFromGitRepoRequest' when calling " +
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void asyncDestroyFromGitRepo(TerraformAsyncDestroyFromGitRepoRequest terraformAsyncDestroyFromGitRepoRequest)
            throws RestClientException {
    ...
    public ResponseEntity<Void> asyncDestroyFromGitRepoWithHttpInfo(
        ...
        if (terraformAsyncDestroyFromGitRepoRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformAsyncDestroyFromGitRepoRequest' when calling " +
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void asyncModifyFromGitRepo(TerraformAsyncModifyFromGitRepoRequest terraformAsyncModifyFromGitRepoRequest)
            throws RestClientException {
    ...
    public ResponseEntity<Void> asyncModifyFromGitRepoWithHttpInfo(
            TerraformAsyncModifyFromGitRepoRequest terraformAsyncModifyFromGitRepoRequest) throws RestClientException {
        ...
        if (terraformAsyncModifyFromGitRepoRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformAsyncModifyFromGitRepoRequest' when calling " +
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public TerraformResult deployFromGitRepo(TerraformDeployFromGitRepoRequest terraformDeployFromGitRepoRequest)
            throws RestClientException {
    ...
    public ResponseEntity<TerraformResult> deployFromGitRepoWithHttpInfo(
            TerraformDeployFromGitRepoRequest terraformDeployFromGitRepoRequest) throws RestClientException {
        ...
        if (terraformDeployFromGitRepoRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformDeployFromGitRepoRequest' when calling " +
                            "deployFromGitRepo");
        }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public TerraformResult destroyFromGitRepo(TerraformDestroyFromGitRepoRequest terraformDestroyFromGitRepoRequest)
            throws RestClientException {
    ...
    public ResponseEntity<TerraformResult> destroyFromGitRepoWithHttpInfo(
            TerraformDestroyFromGitRepoRequest terraformDestroyFromGitRepoRequest) throws RestClientException {
        ...
        if (terraformDestroyFromGitRepoRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformDestroyFromGitRepoRequest' when calling " +
                            "destroyFromGitRepo");
        }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public TerraformResult modifyFromGitRepo(TerraformModifyFromGitRepoRequest terraformModifyFromGitRepoRequest)
            throws RestClientException {
    ...
    public ResponseEntity<TerraformResult> modifyFromGitRepoWithHttpInfo(
            TerraformModifyFromGitRepoRequest terraformModifyFromGitRepoRequest) throws RestClientException {
        ...
        if (terraformModifyFromGitRepoRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformModifyFromGitRepoRequest' when calling " +
                            "modifyFromGitRepo");
        }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public TerraformPlan planFromGitRepo(TerraformPlanFromGitRepoRequest terraformPlanFromGitRepoRequest)
            throws RestClientException {
    ...
    public ResponseEntity<TerraformPlan> planFromGitRepoWithHttpInfo(
            TerraformPlanFromGitRepoRequest terraformPlanFromGitRepoRequest) throws RestClientException {
        ...
        return apiClient.invokeAPI("/terraform-boot/git/plan", HttpMethod.POST, Collections.<String, Object>emptyMap(),
