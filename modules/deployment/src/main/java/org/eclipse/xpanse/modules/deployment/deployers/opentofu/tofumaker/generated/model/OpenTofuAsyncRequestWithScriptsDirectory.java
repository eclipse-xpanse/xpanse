...
/** OpenTofu async request with directory where scripts files exist */
@JsonPropertyOrder({
    OpenTofuAsyncRequestWithScriptsDirectory.JSON_PROPERTY_REQUEST_ID,
    OpenTofuAsyncRequestWithScriptsDirectory.JSON_PROPERTY_REQUEST_TYPE,
    OpenTofuAsyncRequestWithScriptsDirectory.JSON_PROPERTY_OPEN_TOFU_VERSION,
    OpenTofuAsyncRequestWithScriptsDirectory.JSON_PROPERTY_IS_PLAN_ONLY,
    OpenTofuAsyncRequestWithScriptsDirectory.JSON_PROPERTY_VARIABLES,
    OpenTofuAsyncRequestWithScriptsDirectory.JSON_PROPERTY_ENV_VARIABLES,
    OpenTofuAsyncRequestWithScriptsDirectory.JSON_PROPERTY_TF_STATE,
    OpenTofuAsyncRequestWithScriptsDirectory.JSON_PROPERTY_SCRIPTS_DIRECTORY,
    OpenTofuAsyncRequestWithScriptsDirectory.JSON_PROPERTY_WEBHOOK_CONFIG
})
@jakarta.annotation.Generated(
        value = "org.openapitools.codegen.languages.JavaClientCodegen",
        comments = "Generator version: 7.11.0")
public class OpenTofuAsyncRequestWithScriptsDirectory {
    ...
    public OpenTofuAsyncRequestWithScriptsDirectory() {}

    public OpenTofuAsyncRequestWithScriptsDirectory requestId(
    ...
    public OpenTofuAsyncRequestWithScriptsDirectory requestType(
    ...
    public OpenTofuAsyncRequestWithScriptsDirectory openTofuVersion(
    ...
    public OpenTofuAsyncRequestWithScriptsDirectory isPlanOnly(
    ...
    public OpenTofuAsyncRequestWithScriptsDirectory variables(
    ...
    public OpenTofuAsyncRequestWithScriptsDirectory putVariablesItem(
    ...
    public OpenTofuAsyncRequestWithScriptsDirectory envVariables(
    ...
    public OpenTofuAsyncRequestWithScriptsDirectory putEnvVariablesItem(
    ...
    public OpenTofuAsyncRequestWithScriptsDirectory tfState(
    ...
    public OpenTofuAsyncRequestWithScriptsDirectory scriptsDirectory(
    ...
    /**
     * Directory where the OpenTofu scripts files exist.
     *
    ...
    public OpenTofuAsyncRequestWithScriptsDirectory webhookConfig(
    ...
    public boolean equals(Object o) {
        ...
        OpenTofuAsyncRequestWithScriptsDirectory openTofuAsyncRequestWithScriptsDirectory =
                (OpenTofuAsyncRequestWithScriptsDirectory) o;
        return Objects.equals(this.requestId, openTofuAsyncRequestWithScriptsDirectory.requestId)
                && Objects.equals(
                        this.requestType, openTofuAsyncRequestWithScriptsDirectory.requestType)
                && Objects.equals(
                        this.openTofuVersion,
                        openTofuAsyncRequestWithScriptsDirectory.openTofuVersion)
                && Objects.equals(
                        this.isPlanOnly, openTofuAsyncRequestWithScriptsDirectory.isPlanOnly)
                && Objects.equals(
                        this.variables, openTofuAsyncRequestWithScriptsDirectory.variables)
                && Objects.equals(
                        this.envVariables, openTofuAsyncRequestWithScriptsDirectory.envVariables)
                && Objects.equals(this.tfState, openTofuAsyncRequestWithScriptsDirectory.tfState)
                && Objects.equals(
                        this.scriptsDirectory,
                        openTofuAsyncRequestWithScriptsDirectory.scriptsDirectory)
                && Objects.equals(
                        this.webhookConfig, openTofuAsyncRequestWithScriptsDirectory.webhookConfig);
    }
    ...
    public String toString() {
        ...
        sb.append("class OpenTofuAsyncRequestWithScriptsDirectory {\n");
