...
public class ServiceDetailsViewManager {
    ...
    private void handleSensitiveDataInDetails(
        ...
        if (deployedService instanceof DeployedServiceDetails deployedServiceDetails) {
            sensitiveDataHandler.handleSensitiveDataInOutputVariables(
                    outputVariables, deployedServiceDetails.getDeployedServiceProperties());
        } else if (deployedService
                instanceof VendorHostedDeployedServiceDetails deployedServiceDetails) {
            sensitiveDataHandler.handleSensitiveDataInOutputVariables(
                    outputVariables, deployedServiceDetails.getDeployedServiceProperties());
        }
    }
