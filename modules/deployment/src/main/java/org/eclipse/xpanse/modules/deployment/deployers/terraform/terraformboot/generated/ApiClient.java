...
public class ApiClient extends JavaTimeFormatter {
     ...
     */
    public String collectionPathParameterToString(CollectionFormat collectionFormat,
                                                  Collection<?> values) {
    ...
    public MultiValueMap<String, String> parameterToMultiValueMap(CollectionFormat collectionFormat,
        ...
        if (value instanceof Map) {
            @SuppressWarnings("unchecked") final Map<String, Object> valuesMap =
     ...
     */
    public <T> ResponseEntity<T> invokeAPI(String path, HttpMethod method,
        ...
        final BodyBuilder requestBuilder = RequestEntity.method(method,
                UriComponentsBuilder.fromHttpUrl(basePath).toUriString() + finalUri, uriParams);
        if (accept != null) {
