...
public class TerraformFromDirectoryApi extends BaseApi {
    ...
    public ResponseEntity<Void> asyncDeployFromDirectoryWithHttpInfo(String moduleDirectory,
        ...
        if (terraformAsyncDeployFromDirectoryRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformAsyncDeployFromDirectoryRequest' when calling asyncDeployFromDirectory");
        }
        ...
        return apiClient.invokeAPI("/terraform-boot/directory/deploy/async/{module_directory}",
    ...
    public ResponseEntity<Void> asyncDestroyFromDirectoryWithHttpInfo(String moduleDirectory,
        ...
        if (terraformAsyncDestroyFromDirectoryRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformAsyncDestroyFromDirectoryRequest' when calling asyncDestroyFromDirectory");
        }
        ...
        return apiClient.invokeAPI("/terraform-boot/directory/destroy/async/{module_directory}",
    ...
    public ResponseEntity<Void> asyncModifyFromDirectoryWithHttpInfo(String moduleDirectory,
        ...
        if (terraformAsyncModifyFromDirectoryRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformAsyncModifyFromDirectoryRequest' when calling asyncModifyFromDirectory");
        }
        ...
        return apiClient.invokeAPI("/terraform-boot/directory/modify/async/{module_directory}",
                HttpMethod.POST, uriVariables, localVarQueryParams, localVarPostBody,
                localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept,
                localVarContentType, localVarAuthNames, localReturnType);
    }
    ...
    public TerraformResult deployFromDirectory(String moduleDirectory,
        ...
        return deployFromDirectoryWithHttpInfo(moduleDirectory,
                terraformDeployFromDirectoryRequest).getBody();
    }
    ...
    public ResponseEntity<TerraformResult> deployFromDirectoryWithHttpInfo(String moduleDirectory,
        ...
        if (terraformDeployFromDirectoryRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformDeployFromDirectoryRequest' when calling deployFromDirectory");
        }
        ...
        return apiClient.invokeAPI("/terraform-boot/directory/deploy/{module_directory}",
                HttpMethod.POST, uriVariables, localVarQueryParams, localVarPostBody,
                localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept,
                localVarContentType, localVarAuthNames, localReturnType);
    }
    ...
    public TerraformResult destroyFromDirectory(String moduleDirectory,
        ...
        return destroyFromDirectoryWithHttpInfo(moduleDirectory,
                terraformDestroyFromDirectoryRequest).getBody();
    }
    ...
    public ResponseEntity<TerraformResult> destroyFromDirectoryWithHttpInfo(String moduleDirectory,
        ...
        if (terraformDestroyFromDirectoryRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformDestroyFromDirectoryRequest' when calling destroyFromDirectory");
        }
        ...
        return apiClient.invokeAPI("/terraform-boot/directory/destroy/{module_directory}",
                HttpMethod.DELETE, uriVariables, localVarQueryParams, localVarPostBody,
                localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept,
                localVarContentType, localVarAuthNames, localReturnType);
    }
    ...
    public TerraformResult modifyFromDirectory(String moduleDirectory,
        ...
        return modifyFromDirectoryWithHttpInfo(moduleDirectory,
                terraformModifyFromDirectoryRequest).getBody();
    }
    ...
    public ResponseEntity<TerraformResult> modifyFromDirectoryWithHttpInfo(String moduleDirectory,
        ...
        if (terraformModifyFromDirectoryRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'terraformModifyFromDirectoryRequest' when calling modifyFromDirectory");
        }
        ...
        return apiClient.invokeAPI("/terraform-boot/directory/modify/{module_directory}",
                HttpMethod.POST, uriVariables, localVarQueryParams, localVarPostBody,
                localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept,
                localVarContentType, localVarAuthNames, localReturnType);
    }
    ...
    public TerraformPlan plan(String moduleDirectory,
        ...
        return planWithHttpInfo(moduleDirectory, terraformPlanFromDirectoryRequest,
                xCustomRequestId).getBody();
    }
    ...
    public ResponseEntity<TerraformPlan> planWithHttpInfo(String moduleDirectory,
        ...
        if (xCustomRequestId != null) {
            localVarHeaderParams.add("X-Custom-RequestId",
                    apiClient.parameterToString(xCustomRequestId));
        }
        ...
        return apiClient.invokeAPI("/terraform-boot/directory/plan/{module_directory}",
                HttpMethod.POST, uriVariables, localVarQueryParams, localVarPostBody,
                localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept,
                localVarContentType, localVarAuthNames, localReturnType);
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public TerraformValidationResult validateFromDirectory(String moduleDirectory,
    ...
    public ResponseEntity<TerraformValidationResult> validateFromDirectoryWithHttpInfo(
        ...
        return apiClient.invokeAPI(
                "/terraform-boot/directory/validate/{module_directory}/{terraform_version}",
