...
public class OpenTofuFromDirectoryApi extends BaseApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<OpenTofuResult> deployFromDirectoryWithHttpInfo(String moduleDirectory,
                                                                          OpenTofuDeployFromDirectoryRequest openTofuDeployFromDirectoryRequest)
            throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<OpenTofuResult> destroyFromDirectoryWithHttpInfo(String moduleDirectory,
                                                                           OpenTofuDestroyFromDirectoryRequest openTofuDestroyFromDirectoryRequest)
            throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<OpenTofuResult> modifyFromDirectoryWithHttpInfo(String moduleDirectory,
                                                                          OpenTofuModifyFromDirectoryRequest openTofuModifyFromDirectoryRequest)
            throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<OpenTofuPlan> planWithHttpInfo(String moduleDirectory,
        ...
        if (openTofuPlanFromDirectoryRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'openTofuPlanFromDirectoryRequest' when calling plan");
        }
    ...
    public ResponseEntity<OpenTofuValidationResult> validateFromDirectoryWithHttpInfo(String moduleDirectory,
        ...
        if (opentofuVersion == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST,
                    "Missing the required parameter 'opentofuVersion' when calling validateFromDirectory");
        }
