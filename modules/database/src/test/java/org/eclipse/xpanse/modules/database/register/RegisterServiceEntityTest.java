...
class RegisterServiceEntityTest {
    ...
    private static final ServiceRegistrationState SERVICE_STATE = ServiceRegistrationState.REGISTERED;
    private static final Ocl OCL = new Ocl();

    private RegisterServiceEntity test;

    @BeforeEach
    void setUp() {
        test = new RegisterServiceEntity();
        test.setId(ID);
        test.setName(NAME);
    ...
    void testEqualsAndHashCode() {
        ...
        RegisterServiceEntity test1 = new RegisterServiceEntity();
        RegisterServiceEntity test2 = new RegisterServiceEntity();
