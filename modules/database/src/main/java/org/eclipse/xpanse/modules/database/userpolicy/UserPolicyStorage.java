...
public interface UserPolicyStorage {
     ...
     */
    List<UserPolicyEntity> listUserPolicies(UserPolicyQueryRequest query);
     ...
     * @return policyEntity.
     */
    UserPolicyEntity findUserPolicyById(UUID id);
     ...
     */
    void deleteUserPolicies(UserPolicyEntity userPolicyEntity);
     ...
     * @param id the id of the policy.
     */
    void deleteUserPolicyById(UUID id);
}
