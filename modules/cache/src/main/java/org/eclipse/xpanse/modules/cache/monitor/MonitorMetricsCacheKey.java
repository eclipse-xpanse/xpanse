 ...
 */
public record MonitorMetricsCacheKey(Csp csp, String monitorResourceId,
                                     MonitorResourceType monitorResourceType)
        implements Serializable {

    @Serial
    private static final long serialVersionUID = 5713740900243186437L;

    @Override
    public boolean equals(Object obj) {
        if (obj instanceof MonitorMetricsCacheKey key) {
            return key.csp == this.csp && key.monitorResourceId.equals(this.monitorResourceId)
    ...
    public int hashCode() {
        ...
        result = prime * result + ((monitorResourceType == null) ? 0
                : monitorResourceType.hashCode());
        return result;
    }
}
