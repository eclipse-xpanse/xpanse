...
class CredentialCacheKeyTest {
    ...
    private final CredentialCacheKey testCacheKey =
    ...
    void testToString() {
        String result =
                "CredentialCacheKey[csp=HUAWEI_CLOUD, site=Chinese Mainland, "
