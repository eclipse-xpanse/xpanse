...
public interface Deployer {
     ...
     * given service. This can be the terraform plan as JSON or pulumi's preview as JSON. The JSON
     * string must be something that will be used for creating rego policy files. This is generally
     * a feature provided by the underlying infrastructure deployment tool.
     *
     * @param task DeployTask of the service deployment.
     * @return JSON representation of infrastructure changes that would be created by the service
     *     deployment.
     */
